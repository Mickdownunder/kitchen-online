...
export const handleCreateSupplier: ServerHandler = async (args, supabase, userId) => {
  ...
  const { data: supplier, error } = await supabase
    ...
    .insert({
      ...
      phone: (args.phone as string) || null,
      contact_person_internal: (args.contactPersonInternal as string) || null,
      contact_person_internal_phone: (args.contactPersonInternalPhone as string) || null,
      contact_person_internal_email: (args.contactPersonInternalEmail as string) || null,
      contact_person_external: (args.contactPersonExternal as string) || null,
      contact_person_external_phone: (args.contactPersonExternalPhone as string) || null,
      contact_person_external_email: (args.contactPersonExternalEmail as string) || null,
      street: (args.street as string) || null,
      house_number: (args.houseNumber as string) || null,
      postal_code: (args.postalCode as string) || null,
